...
class RestClient(object):
    ...
    def index(self, currency):
        return self.request("/api/v1/public/index", {'currency':currency})

    def stats(self):
        return self.request("/api/v1/public/stats", {})

    def account(self, currency, ext):
        return self.request("/api/v1/private/account", {'currency': currency, 'ext': ext})

    def buy(self, instrument, quantity, price, type="limit", time_in_force= "fill_or_kill", postOnly=None, label=None):
        options = {
            "instrument": instrument,
            "quantity": quantity,
            "price": price,
    ...
    def sell(self, instrument, quantity, price, type="limit", time_in_force= "fill_or_kill", postOnly=None, label=None):
        options = {
            "instrument": instrument,
            "quantity": quantity,
            "price": price,
